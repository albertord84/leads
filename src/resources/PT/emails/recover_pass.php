...
<!--            <a href="<?php // echo 'https://dumbu.pro/leads/src/index.php/welcome/password_recovery?language=PT&token='.$_GET["token"]; ?>">
            ...
            <a href="<?php echo 'https://localhost/leads/src/index.php/welcome/password_recovery?language=PT&token='.$_GET["token"]; ?>">
                <?php echo 'https://localhost/leads/src/index.php/welcome/password_recovery?language=PT&token='.$_GET["token"]; ?>
            </a> 
            <br>

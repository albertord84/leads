...
namespace leads\cls {
    ...
    require_once $_SERVER['DOCUMENT_ROOT'] . '/leads/worker/libraries/mundipagg/init.php';
...
//                        ->setOrderReference('NumeroDoPedido');
        ...
        public function create_boleto_payment($payment_data) {
            try {
                ...
                require_once $_SERVER['DOCUMENT_ROOT'] . '/leads/worker/libraries/MundiAPI-PHP/vendor/autoload.php';
                // Define a url utilizada

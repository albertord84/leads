...
//                            echo ("<br>\n No nodes!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        ...
        public function get_insta_followers($login_data, $user, $N, &$cursor = NULL, $proxy = "") {
            try {
                ...
                $curl_str = "curl --proxy 'albertreye9917:3r4rcz0b1v@207.188.155.18:21316' 'https://www.instagram.com/graphql/query/?query_hash=37479f2b8209594dde7facb0d904896a&variables=%7B%22id%22%3A%221490955331%22%2C%22first%22%3A50%2C%22after%22%3A%22AQAWUnHt1x5wNI2lAYnk71-ipiRg21oIx_z1Xv9QrhVOMJ3WDxy_kmv-VmBRKmJ01rCMMmrma1CCIyCXUc7ylQYwdhqEjGakZ6fEzsfcB7T9CbtswRGPyQoQ%22%7D' -H 'Cookie: mid=WrEhpAABAAGDpDeTMyjc1SdxmvLU; sessionid=IGSC7835a973f96e79bca30d067ed770ef96936c08b966345ff61d73e7a51b0be8ea%3ADou3OrDxrIHRPzmGMpNqM6mJK7LfUXuz%3A%7B%22_auth_user_id%22%3A4542814483%2C%22_auth_user_backend%22%3A%22accounts.backends.CaseInsensitiveModelBackend%22%2C%22_auth_user_hash%22%3A%22%22%2C%22_platform%22%3A1%2C%22_token_ver%22%3A2%2C%22_token%22%3A%224542814483%3AMQ0OTVLHpcNB8bpp2GvykIucISQRYsXS%3Af9483005e40d6224946e129dc384c14f3a27f49327327adf9b96b7d66e1904e4%22%2C%22last_refreshed%22%3A1539757823.2871046066%7D; s_network=; ig_pr=1; ig_vw=1855; csrftoken=NtTZs2ELJkGNMC2EPJP2bmcrkM6b3GV1; ds_user_id=4542814483' -H 'X-CSRFToken: NtTZs2ELJkGNMC2EPJP2bmcrkM6b3GV1' -H 'Origin: https://www.instagram.com' -H 'Accept-Encoding: gzip, deflate' -H 'Accept-Language: pt-BR,pt;q=0.8,en-US;q=0.6,en;q=0.4' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.139 Safari/537.36' -H 'X-Requested-with: XMLHttpRequest' -H 'content-type: application/x-www-form-urlencoded' -H 'Accept: */*' -H 'Referer: https://www.instagram.com/' -H 'Authority: www.instagram.com' --compressed";
                if ($curl_str === NULL)
                    return NULL;
